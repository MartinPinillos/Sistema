...
namespace Sistema.Presentacion
{
    public partial class FrmPrincipal : Form
    {
        ...
        { //Cuando cargue el formulario va contener la siguiente informacion
            StBarraInferior.Text = "Dev. by Me , Usuario: " + this.Nombre;
        ...
        {
            DialogResult Opcion;
            Opcion = MessageBox.Show("Deseas salir del sistema?","Sistema Ventas",MessageBoxButtons.OKCancel,MessageBoxIcon.Question);
