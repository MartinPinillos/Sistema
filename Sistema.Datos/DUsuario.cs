    ...
    public class DUsuario
    {
        ...
        public DataTable Login(string Email, string Clave)
        {
            ...
            try
            {
                ...
                Resultado = Comando.ExecuteReader();
                Tabla.Load(Resultado);
                return Tabla;  //si el Email y Clave son correctos va a devolver el usuario en el Objeto Tabla del DataTable.
            }
            catch (Exception ex)
            {
                return null;  // si tenemos un error le voy a indicar que retorne un null a la capa Negocio
                throw ex;
            }
            finally
            {
